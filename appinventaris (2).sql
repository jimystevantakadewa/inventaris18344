...
(3, 'Hanif PP', 'Selesai', 'belum', 9, 5, '2024-05-27', 3, '12', 10, '2024-05-26 17:00:23', '2024-05-26 17:00:23'),
(4, 'Axioo L 30000', 'Selesai', 'masih mulus halus', 5, 6, '2024-05-27', 4, '307', 12, '2024-05-26 22:53:09', '2024-05-26 22:53:09'),
(6, 'Ryan Mee', 'Selesai', '-', 1, 7, '2024-05-30', 6, '666', 14, '2024-05-29 19:20:09', '2024-05-29 19:20:09');
...
(7, 'Vario 59 Free Ongkir', '6666', 'MGM(Metu Gang Mumbul)', NULL, NULL);
...
(1, 'Widodo', 6666, 'Kartika Motor Speed', NULL, NULL);
...
(14, 'Dies', '$2y$10$nrsRUrzkSkskap494I7tyeHaxPcCprweEWiTj1UDxQr7o4QmHJFWC', 'Yudies Kurcaci', 2, NULL, NULL);
...
(6, 'Kartika Motor Speed', '666', '-', NULL, NULL);
...
--
ALTER TABLE `inventaris`
  MODIFY `idinventaris` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=7;
...
--
ALTER TABLE `pegawais`
  MODIFY `idpegawai` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=8;
...
--
ALTER TABLE `petugas`
  MODIFY `idpetugas` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=15;

--
-- AUTO_INCREMENT for table `ruangs`
--
ALTER TABLE `ruangs`
  MODIFY `idruang` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=7;
